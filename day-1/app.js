...
add up the distances between all of the pairs you found. In the example above, this is 2 + 1 + 0 + 1 + 2 + 5, a total distance of 11!
...
const findDistance = (id1, id2) => {
  ...
  for (let i = 0; i < id1Array.length; i++) {
    const num1 = Number(id1Array[i]);
    const num2 = Number(id2Array[i]);
